...
public class ManagerLogin extends JFrame implements  ActionListener{
	...
	//定义组件 
	JLabel lb1=new JLabel("当前是图书管理人员登录界面" );//JLabel 对象可以显示文本、图像
   ...
   //   ph.add(查询);//
      ...
      con.setLayout(new BorderLayout());//设置布局为边框布局
      
      con.add(pb, BorderLayout.NORTH);
      con.add(pv, BorderLayout.CENTER);
      con.add(ph, BorderLayout.SOUTH);
      setDefaultCloseOperation(EXIT_ON_CLOSE);//置一个默认的关闭操作
